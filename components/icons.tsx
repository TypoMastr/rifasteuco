...
export const ArrowUpOnSquareIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 8.25H7.5a2.25 2.25 0 0 0-2.25 2.25v9a2.25 2.25 0 0 0 2.25 2.25h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25H15M9 12l3-3m0 0 3 3m-3-3v11.25" />
    </svg>
);
...
export const FingerprintIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0 1 19.5 12c0 2.42-.943 4.638-2.499 6.32a7.5 7.5 0 0 1-12.002-4.065.75.75 0 0 0 .363-1.118l-1.37-1.37a.75.75 0 0 0-1.061 0l-1.06 1.06a.75.75 0 0 0 0 1.06l4.638 4.638a7.5 7.5 0 0 0 10.607 0l2.499-2.499a7.5 7.5 0 0 0 0-10.606A7.5 7.5 0 0 0 12 4.5c-2.42 0-4.638.943-6.32 2.499a.75.75 0 0 0-1.06 1.06l1.06 1.06a.75.75 0 0 0 1.06 0l1.37-1.37a.75.75 0 0 0-1.118-.364Z" />
  </svg>
);
